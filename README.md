...
Необходимо выполнить все задлания с пометкой **"задача"** [практической работы №3](https://docs.google.com/document/d/1koLV9iGXJfL2yh88InKo4AVXxWqMIJOqmzT4XFYlWuU/edit?usp=sharing) практической работы. Полученную программу залить в папку этого репозитория **sutdents/группа/practical_works/фамилия_имя/simple_django_web_project**. Инструкция о загрузке работы ниже. Не забывайте о файле гитигнор. 

## Практическая работа №4

Необходимо выполнить все задлания с пометкой **"задача"** [практической работы №4](https://docs.google.com/document/d/1kQ36RlRtxqpjtUtfr-WCWkuJ1SYvSG4220Ops2X0viw/edit) практической работы. Полученную программу залить в папку этого репозитория **sutdents/группа/practical_works/фамилия_имя/simple_django_web_project**. Инструкция о загрузке работы ниже. Не забывайте о файле гитигнор. 
...
Текст практической работы [тут](https://drive.google.com/file/d/1kp4xcF-6r-g5jvephy69n9XvS-7hU4KT/view?usp=sharing).<br>
Срок сдачи: **10.12.2020** (включительно)<br>
...
1. Изучить индивидуальный вариант.
2. Запустить новый проект PyCharm.
2. Составить описание модели базы данных и согласовать его с преподавателем (программа [dbdesigner](https://www.dbdesigner.net/)
3. Реализовать базу данных в Django, в файле models.py.
4. Согласовать с преподавателем список интерфейсов (страниц) для разработки.
5. Разработать файлы представлений(views.py) и шаблонов(*.html).<br>
...
Как делать пул-реквест описано в разделе **[Сдача работ](https://github.com/TonikX/ITMO_ICT_WebProgramming_2020-2021_d3310/blob/master/README.md#%D1%81%D0%B4%D0%B0%D1%87%D0%B0-%D1%80%D0%B0%D0%B1%D0%BE%D1%82)**
